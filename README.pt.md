...
2. **"Ferramentas" Cibersegurança**
   - a forma mais simples é utilizar um [VPS](https://www.hostinger.com/pt?REFERRALCODE=FRNOSCARALKR) ou [VM]((https://www.kali.org/get-kali/#kali-virtual-machines) com o [Kali Linux](https://www.kali.org) e seguir os seguintes documentos:
