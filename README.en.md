...
1. **"Hardening" of Hosting / Website / Web Platform**
   ...
   - Latest software versions (operating system, database, content management system, frameworks, libraries, plugins, themes, etc.) without security vulnerabilities, and "acquired" from trusted sources, see <a href="LibraryReleases.md" target="_blank">Library Releases</a>
