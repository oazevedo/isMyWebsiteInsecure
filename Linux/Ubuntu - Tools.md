...
1. [Subject X](#subject-x)
2. [Subject Y](#subject-y)
...
sudo apt install -y ruby-full     # Gem is a Ruby package manager and comes bundled with Ruby.
...
# allways check what is the latest version
...
# Whois  
# https://github.com/rfc1036/whois/tags
# allways check what is the latest version
cd $HOME/Downloads
...
# WPScan  
# https://github.com/wpscanteam/wpscan/releases
...
# https://www.zaproxy.org/download/ , install with snap is officially supported
# to update: sudo snap refresh zaproxy
sudo snap install zaproxy --classic


# isMyWebsiteInsecure-*.sh
# https://github.com/oazevedo/isMyWebsiteInsecure    # alterar de /oazevedo/ para /si-aeportugal/
# raw.githubusercontent.com: download the file directly as it is intended to be used (e.g., a shell script, text file, etc.)
cd $HOME/tools
...
# ProtonVPN - cli     # Note: Optional installation
